...
void agent::update(agent *arr){  // influence the main vector 
  ...
  //___________________mouse gravity 0.06
    
    
  //  velDir = velDir + gravity;
    float mouseAngle = velDir.angle(mouse - location);
    velDir.rotate(mouseAngle * 0.06);
...
void ofApp::draw(){
  ...
  ofColor aqua(255, 57, 74, alpha);
  ofColor purple(255, 127, 102, alpha);
